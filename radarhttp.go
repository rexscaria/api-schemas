...
type RadarHTTPGetTimeseriesResponseResult struct {
	...
	Serie0 RadarHTTPGetTimeseriesResponseResultSerie0 `json:"serie_0,required"`
...
type RadarHTTPGetTimeseriesResponseResultMeta struct {
	...
	ConfidenceInfo RadarHTTPGetTimeseriesResponseResultMetaConfidenceInfo `json:"confidenceInfo"`
...
type RadarHTTPGetTimeseriesResponseResultMetaConfidenceInfo struct {
	Annotations []RadarHTTPGetTimeseriesResponseResultMetaConfidenceInfoAnnotation `json:"annotations"`
...
type RadarHTTPGetTimeseriesResponseResultSerie0 struct {
	Timestamps []time.Time                                    `json:"timestamps,required" format:"date-time"`
	Values     []string                                       `json:"values,required"`
	JSON       radarHTTPGetTimeseriesResponseResultSerie0JSON `json:"-"`
}

// radarHTTPGetTimeseriesResponseResultSerie0JSON contains the JSON metadata for
// the struct [RadarHTTPGetTimeseriesResponseResultSerie0]
type radarHTTPGetTimeseriesResponseResultSerie0JSON struct {
...
func (r *RadarHTTPGetTimeseriesResponseResultSerie0) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r radarHTTPGetTimeseriesResponseResultSerie0JSON) RawJSON() string {
	return r.raw
}

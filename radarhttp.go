...
type RadarHTTPGetTimeseriesResponse struct {
	Result  RadarHTTPGetTimeseriesResponseResult `json:"result" api:"required"`
...
type RadarHTTPGetTimeseriesResponseResult struct {
	...
	Meta        RadarHTTPGetTimeseriesResponseResultMeta        `json:"meta" api:"required"`
	ExtraFields map[string]RadarHTTPGetTimeseriesResponseResult `json:"-" api:"extrafields"`
...
type RadarHTTPGetTimeseriesResponseResultMeta struct {
	...
	AggInterval    RadarHTTPGetTimeseriesResponseResultMetaAggInterval    `json:"aggInterval" api:"required"`
	ConfidenceInfo RadarHTTPGetTimeseriesResponseResultMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []RadarHTTPGetTimeseriesResponseResultMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization RadarHTTPGetTimeseriesResponseResultMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []RadarHTTPGetTimeseriesResponseResultMetaUnit `json:"units" api:"required"`
...
type RadarHTTPGetTimeseriesResponseResultMetaConfidenceInfo struct {
	Annotations []RadarHTTPGetTimeseriesResponseResultMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`

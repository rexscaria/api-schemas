...
type AccountAIRunCfFblgitExecuteUnaCybertron7bV2Bf16ParamsBodyMessages struct {
	...
	Messages param.Field[[]AccountAIRunCfFblgitExecuteUnaCybertron7bV2Bf16ParamsBodyMessagesMessage] `json:"messages" api:"required"`
	// Decreases the likelihood of the model repeating the same lines verbatim.
	FrequencyPenalty param.Field[float64]                                                                     `json:"frequency_penalty"`
...
type AccountAIRunCfFblgitExecuteUnaCybertron7bV2Bf16ParamsBodyMessagesToolsObject struct {
	...
	Parameters param.Field[AccountAIRunCfFblgitExecuteUnaCybertron7bV2Bf16ParamsBodyMessagesToolsObjectParameters] `json:"parameters" api:"required"`
}
...
type AccountAIRunCfFblgitExecuteUnaCybertron7bV2Bf16ParamsBodyMessagesToolsObjectParameters struct {
	...
	Properties param.Field[map[string]AccountAIRunCfFblgitExecuteUnaCybertron7bV2Bf16ParamsBodyMessagesToolsObjectParametersProperties] `json:"properties" api:"required"`

...
func (r *AccountLogpushJobService) New(ctx context.Context, accountID string, body AccountLogpushJobNewParams, opts ...option.RequestOption) (res *JobResponseSingle, err error) {
	opts = append(r.Options[:], opts...)
	if accountID == "" {
		err = errors.New("missing required account_id parameter")
		return
	}
	path := fmt.Sprintf("accounts/%s/logpush/jobs", accountID)
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodPost, path, body, &res, opts...)
	return
}

// Gets the details of a Logpush job.
func (r *AccountLogpushJobService) Get(ctx context.Context, accountID string, jobID int64, opts ...option.RequestOption) (res *JobResponseSingle, err error) {
	opts = append(r.Options[:], opts...)
	if accountID == "" {
		err = errors.New("missing required account_id parameter")
		return
	}
	path := fmt.Sprintf("accounts/%s/logpush/jobs/%v", accountID, jobID)
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodGet, path, nil, &res, opts...)
	return
}

// Updates a Logpush job.
func (r *AccountLogpushJobService) Update(ctx context.Context, accountID string, jobID int64, body AccountLogpushJobUpdateParams, opts ...option.RequestOption) (res *JobResponseSingle, err error) {
	opts = append(r.Options[:], opts...)
	if accountID == "" {
		err = errors.New("missing required account_id parameter")
		return
...
func (r *AccountLogpushJobService) List(ctx context.Context, accountID string, opts ...option.RequestOption) (res *JobResponseCollection, err error) {
	opts = append(r.Options[:], opts...)
	if accountID == "" {
		err = errors.New("missing required account_id parameter")
		return
...
func (r *AccountLogpushJobService) Delete(ctx context.Context, accountID string, jobID int64, body AccountLogpushJobDeleteParams, opts ...option.RequestOption) (res *AccountLogpushJobDeleteResponse, err error) {
	opts = append(r.Options[:], opts...)
	if accountID == "" {
		err = errors.New("missing required account_id parameter")
		return
...
type CommonResponseLogPush struct {
	Errors   []MessagesLogpushItem `json:"errors,required"`
	Messages []MessagesLogpushItem `json:"messages,required"`
	// Whether the API call was successful.
	Success CommonResponseLogPushSuccess `json:"success,required"`
	JSON    commonResponseLogPushJSON    `json:"-"`
}

// commonResponseLogPushJSON contains the JSON metadata for the struct
// [CommonResponseLogPush]
type commonResponseLogPushJSON struct {
...
func (r *CommonResponseLogPush) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r commonResponseLogPushJSON) RawJSON() string {
	return r.raw
}

// Whether the API call was successful.
type CommonResponseLogPushSuccess bool

const (
	CommonResponseLogPushSuccessTrue CommonResponseLogPushSuccess = true
)

func (r CommonResponseLogPushSuccess) IsKnown() bool {
	switch r {
	case CommonResponseLogPushSuccessTrue:
		return true
	}
	return false
}
...
func (r Frequency) IsKnown() bool {
	switch r {
	case FrequencyHigh, FrequencyLow:
		return true
	}
	return false
}
...
type JobResponseSingle struct {
	...
	JSON   jobResponseSingleJSON `json:"-"`
	SingleResponseJob
}

// jobResponseSingleJSON contains the JSON metadata for the struct
// [JobResponseSingle]
type jobResponseSingleJSON struct {
	Result      apijson.Field
	raw         string
	ExtraFields map[string]apijson.Field
}

func (r *JobResponseSingle) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r jobResponseSingleJSON) RawJSON() string {
	return r.raw
}
...
type LogpushJob struct {
	...
	Frequency Frequency `json:"frequency,nullable"`
	...
	Kind LogpushKind `json:"kind,nullable"`
...
// Log Delivery jobs. Currently, Edge Log Delivery is only supported for the
// `http_requests` dataset.
type LogpushKind string

const (
	LogpushKindEdge LogpushKind = "edge"
)

func (r LogpushKind) IsKnown() bool {
	switch r {
	case LogpushKindEdge:
		return true
	}
	return false
}
...
type SingleResponseJob struct {
	Errors   []MessagesLogpushItem `json:"errors,required"`
	Messages []MessagesLogpushItem `json:"messages,required"`
	// Whether the API call was successful.
	Success SingleResponseJobSuccess `json:"success,required"`
	JSON    singleResponseJobJSON    `json:"-"`
}

// singleResponseJobJSON contains the JSON metadata for the struct
// [SingleResponseJob]
type singleResponseJobJSON struct {
	Errors      apijson.Field
	Messages    apijson.Field
	Success     apijson.Field
	raw         string
...
func (r *SingleResponseJob) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r singleResponseJobJSON) RawJSON() string {
	return r.raw
}

// Whether the API call was successful.
type SingleResponseJobSuccess bool

const (
	SingleResponseJobSuccessTrue SingleResponseJobSuccess = true
)

func (r SingleResponseJobSuccess) IsKnown() bool {
	switch r {
	case SingleResponseJobSuccessTrue:
		return true
	}
	return false
}
...
type AccountLogpushJobDeleteResponse struct {
	Result AccountLogpushJobDeleteResponseResult `json:"result"`
...
func (r accountLogpushJobDeleteResponseJSON) RawJSON() string {
	return r.raw
}

type AccountLogpushJobDeleteResponseResult struct {
	// Unique id of the job.
	ID   int64                                     `json:"id"`
	JSON accountLogpushJobDeleteResponseResultJSON `json:"-"`
}

// accountLogpushJobDeleteResponseResultJSON contains the JSON metadata for the
// struct [AccountLogpushJobDeleteResponseResult]
type accountLogpushJobDeleteResponseResultJSON struct {
	ID          apijson.Field
	raw         string
	ExtraFields map[string]apijson.Field
}

func (r *AccountLogpushJobDeleteResponseResult) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r accountLogpushJobDeleteResponseResultJSON) RawJSON() string {
	return r.raw
}

type AccountLogpushJobNewParams struct {
	// Uniquely identifies a resource (such as an s3 bucket) where data will be pushed.
	// Additional configuration parameters supported by the destination may be
	// included.
...
func (r AccountLogpushJobNewParams) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}
...
type AccountLogpushJobDeleteParams struct {
	Body interface{} `json:"body,required"`
}

func (r AccountLogpushJobDeleteParams) MarshalJSON() (data []byte, err error) {

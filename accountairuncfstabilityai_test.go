...
func TestAccountAIRunCfStabilityaiExecuteStableDiffusionXlBase1_0WithOptionalParams(t *testing.T) {
	...
	resp, err := client.Accounts.AI.Run.Cf.Stabilityai.ExecuteStableDiffusionXlBase1_0(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cfrex.AccountAIRunCfStabilityaiExecuteStableDiffusionXlBase1_0Params{
			Prompt:         cfrex.F("x"),

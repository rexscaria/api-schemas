...
func (r *AccountDevicePostureIntegrationService) New(ctx context.Context, accountID interface{}, body AccountDevicePostureIntegrationNewParams, opts ...option.RequestOption) (res *SingleResponseIntegration, err error) {
...
func (r *AccountDevicePostureIntegrationService) Get(ctx context.Context, accountID interface{}, integrationID string, opts ...option.RequestOption) (res *SingleResponseIntegration, err error) {
	opts = append(r.Options[:], opts...)
	if integrationID == "" {
...
func (r *AccountDevicePostureIntegrationService) Update(ctx context.Context, accountID interface{}, integrationID string, body AccountDevicePostureIntegrationUpdateParams, opts ...option.RequestOption) (res *SingleResponseIntegration, err error) {
	opts = append(r.Options[:], opts...)
	if integrationID == "" {
		err = errors.New("missing required integration_id parameter")
		return
...
func (r *AccountDevicePostureIntegrationService) List(ctx context.Context, accountID interface{}, opts ...option.RequestOption) (res *AccountDevicePostureIntegrationListResponse, err error) {
	opts = append(r.Options[:], opts...)
	path := fmt.Sprintf("accounts/%v/devices/posture/integration", accountID)
	err = requestconfig.ExecuteNewRequest(ctx, http.MethodGet, path, nil, &res, opts...)
	return
...
func (r *AccountDevicePostureIntegrationService) Delete(ctx context.Context, accountID interface{}, integrationID string, body AccountDevicePostureIntegrationDeleteParams, opts ...option.RequestOption) (res *AccountDevicePostureIntegrationDeleteResponse, err error) {
	opts = append(r.Options[:], opts...)
	if integrationID == "" {
		err = errors.New("missing required integration_id parameter")
		return
...
const (
	...
	DeviceTypePostureIntegrationTanium         DeviceTypePostureIntegration = "tanium"
...
type SingleResponseIntegration struct {
	Result DevicePostureIntegrations     `json:"result"`
...
type AccountDevicePostureIntegrationDeleteParams struct {
	Body interface{} `json:"body,required"`
}

func (r AccountDevicePostureIntegrationDeleteParams) MarshalJSON() (data []byte, err error) {

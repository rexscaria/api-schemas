...
type RadarBgpIPGetTimeseriesResponse struct {
	Result  RadarBgpIPGetTimeseriesResponseResult `json:"result" api:"required"`
...
type RadarBgpIPGetTimeseriesResponseResult struct {
	...
	Meta   RadarBgpIPGetTimeseriesResponseResultMeta   `json:"meta" api:"required"`
	Serie0 RadarBgpIPGetTimeseriesResponseResultSerie0 `json:"serie_0" api:"required"`
...
type RadarBgpIPGetTimeseriesResponseResultMeta struct {
	...
	AggInterval    RadarBgpIPGetTimeseriesResponseResultMetaAggInterval    `json:"aggInterval" api:"required"`
	ConfidenceInfo RadarBgpIPGetTimeseriesResponseResultMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []RadarBgpIPGetTimeseriesResponseResultMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization RadarBgpIPGetTimeseriesResponseResultMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []RadarBgpIPGetTimeseriesResponseResultMetaUnit `json:"units" api:"required"`
...
type RadarBgpIPGetTimeseriesResponseResultMetaConfidenceInfo struct {
	Annotations []RadarBgpIPGetTimeseriesResponseResultMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
...
type RadarBgpIPGetTimeseriesResponseResultMetaDelay struct {
	AsnData     RadarBgpIPGetTimeseriesResponseResultMetaDelayAsnData     `json:"asn_data" api:"required"`
	CountryData RadarBgpIPGetTimeseriesResponseResultMetaDelayCountryData `json:"country_data" api:"required"`
...
type RadarBgpIPGetTimeseriesResponseResultMetaDelayAsnData struct {
	...
	Healthy   bool                                                        `json:"healthy" api:"required"`
	Latest    RadarBgpIPGetTimeseriesResponseResultMetaDelayAsnDataLatest `json:"latest" api:"required"`
...
type RadarBgpIPGetTimeseriesResponseResultMetaDelayCountryData struct {
	...
	DelayStr  string                                                          `json:"delayStr" api:"required"`
	Healthy   bool                                                            `json:"healthy" api:"required"`
	Latest    RadarBgpIPGetTimeseriesResponseResultMetaDelayCountryDataLatest `json:"latest" api:"required"`

...
type AccountAIRunCfTiiuaeExecuteFalcon7bInstructParamsBodyMessages struct {
	...
	Messages param.Field[[]AccountAIRunCfTiiuaeExecuteFalcon7bInstructParamsBodyMessagesMessage] `json:"messages" api:"required"`
	// Decreases the likelihood of the model repeating the same lines verbatim.
	FrequencyPenalty param.Field[float64]                                                                 `json:"frequency_penalty"`
...
type AccountAIRunCfTiiuaeExecuteFalcon7bInstructParamsBodyMessagesToolsObject struct {
	...
	Parameters param.Field[AccountAIRunCfTiiuaeExecuteFalcon7bInstructParamsBodyMessagesToolsObjectParameters] `json:"parameters" api:"required"`
}
...
type AccountAIRunCfTiiuaeExecuteFalcon7bInstructParamsBodyMessagesToolsObjectParameters struct {
	...
	Properties param.Field[map[string]AccountAIRunCfTiiuaeExecuteFalcon7bInstructParamsBodyMessagesToolsObjectParametersProperties] `json:"properties" api:"required"`

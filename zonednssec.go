...
type DnssecResponse struct {
	Errors   []DnssecMessageItem `json:"errors" api:"required"`
	Messages []DnssecMessageItem `json:"messages" api:"required"`
	// Whether the API call was successful.
	Success DnssecResponseSuccess `json:"success" api:"required"`
...
type DnssecResponseResult struct {
	...
	// Digest hash.
	Digest string `json:"digest" api:"nullable"`
	// Type of digest algorithm.
	DigestAlgorithm string `json:"digest_algorithm" api:"nullable"`
	// Coded type for digest algorithm.
	DigestType string `json:"digest_type" api:"nullable"`
	...
	// Full DS record.
	Ds string `json:"ds" api:"nullable"`
	// Flag for DNSSEC record.
	Flags float64 `json:"flags" api:"nullable"`
	// Code for key tag.
	KeyTag float64 `json:"key_tag" api:"nullable"`
	// Algorithm key type.
	KeyType string `json:"key_type" api:"nullable"`
...
type ZoneDnssecDeleteResponse struct {
	...
	Messages []DnssecMessageItem `json:"messages" api:"required"`
	// Whether the API call was successful.
	Success ZoneDnssecDeleteResponseSuccess `json:"success" api:"required"`

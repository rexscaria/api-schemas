	...
	_, err := client.Accounts.Pages.Projects.New(
		...
		cfrex.AccountPageProjectNewParams{
			Project: cfrex.ProjectParam{
				...
				Source: cfrex.F(cfrex.SourceParam{
					Config: cfrex.F(cfrex.SourceConfigParam{
						DeploymentsEnabled:           cfrex.F(true),
						Owner:                        cfrex.F("owner"),
						PathExcludes:                 cfrex.F([]string{"string"}),
						PathIncludes:                 cfrex.F([]string{"string"}),
						PrCommentsEnabled:            cfrex.F(true),
						PreviewBranchExcludes:        cfrex.F([]string{"string"}),
						PreviewBranchIncludes:        cfrex.F([]string{"string"}),
						PreviewDeploymentSetting:     cfrex.F(cfrex.SourceConfigPreviewDeploymentSettingAll),
						ProductionBranch:             cfrex.F("production_branch"),
						ProductionDeploymentsEnabled: cfrex.F(true),
						RepoName:                     cfrex.F("repo_name"),
					}),
					Type: cfrex.F("type"),
				}),
			},

...
type RadarRobotsTxtTopGetTopDomainCategoriesResponse struct {
	Result  RadarRobotsTxtTopGetTopDomainCategoriesResponseResult `json:"result" api:"required"`
...
type RadarRobotsTxtTopGetTopDomainCategoriesResponseResult struct {
	...
	Meta RadarRobotsTxtTopGetTopDomainCategoriesResponseResultMeta   `json:"meta" api:"required"`
	Top0 []RadarRobotsTxtTopGetTopDomainCategoriesResponseResultTop0 `json:"top_0" api:"required"`
...
type RadarRobotsTxtTopGetTopDomainCategoriesResponseResultMeta struct {
	ConfidenceInfo RadarRobotsTxtTopGetTopDomainCategoriesResponseResultMetaConfidenceInfo `json:"confidenceInfo" api:"required,nullable"`
	DateRange      []RadarRobotsTxtTopGetTopDomainCategoriesResponseResultMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization RadarRobotsTxtTopGetTopDomainCategoriesResponseResultMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []RadarRobotsTxtTopGetTopDomainCategoriesResponseResultMetaUnit `json:"units" api:"required"`
...
type RadarRobotsTxtTopGetTopDomainCategoriesResponseResultMetaConfidenceInfo struct {
	Annotations []RadarRobotsTxtTopGetTopDomainCategoriesResponseResultMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`

...
func TestAccountSlurperJobNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.Slurper.Jobs.New(
		context.TODO(),
		"account_id",
		cfrex.AccountSlurperJobNewParams{
			Overwrite: cfrex.F(true),
			Source: cfrex.F[cfrex.SourceJobSchemaUnionParam](cfrex.SourceJobSchemaR2SlurperS3SourceSchemaParam{
			...
			Target: cfrex.F(cfrex.R2TargetSchemaParam{
				Bucket:       cfrex.F("bucket"),
				Jurisdiction: cfrex.F(cfrex.JurisdictionDefault),
				Secret: cfrex.F(cfrex.S3LikeCredsSchemaParam{
					AccessKeyID:     cfrex.F("accessKeyId"),
					SecretAccessKey: cfrex.F("secretAccessKey"),
				}),
				Vendor: cfrex.F(cfrex.R2TargetSchemaVendorR2),
			}),
		},
	)
	if err != nil {
...
func TestAccountSlurperJobListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.Slurper.Jobs.List(
		context.TODO(),
		"account_id",
		cfrex.AccountSlurperJobListParams{
			Limit:  cfrex.F(int64(50)),
...
func TestAccountSlurperJobGetLogsWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.Slurper.Jobs.GetLogs(
		...
		"account_id",
		"job_id",
		cfrex.AccountSlurperJobGetLogsParams{
			Limit:  cfrex.F(int64(50)),
			Offset: cfrex.F(int64(0)),
		},
	)

...
func TestZonePageShieldPolicyNew(t *testing.T) {
	...
	_, err := client.Zones.PageShield.Policies.New(
		...
		cfrex.ZonePageShieldPolicyNewParams{
			Policy: cfrex.PolicyParam{
				Action:      cfrex.F(cfrex.PolicyActionAllow),
				Description: cfrex.F("Checkout page CSP policy"),
				Enabled:     cfrex.F(true),
				Expression:  cfrex.F(`ends_with(http.request.uri.path, "/checkout")`),
				Value:       cfrex.F("script-src 'none';"),
			},
		},
	)
	if err != nil {
...
func TestZonePageShieldPolicyUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Zones.PageShield.Policies.Update(
		...
		"023e105f4ecef8ad9ca31a8372d0c353",
		"023e105f4ecef8ad9ca31a8372d0c353",
		cfrex.ZonePageShieldPolicyUpdateParams{
			Action:      cfrex.F(cfrex.PolicyActionAllow),
			Description: cfrex.F("Checkout page CSP policy"),
			Enabled:     cfrex.F(true),
			Expression:  cfrex.F(`ends_with(http.request.uri.path, "/checkout")`),

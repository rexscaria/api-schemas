...
type RadarAIInferenceTimeseriesGroupGetModelResponse struct {
	Result  RadarAIInferenceTimeseriesGroupGetModelResponseResult `json:"result" api:"required"`
...
type RadarAIInferenceTimeseriesGroupGetModelResponseResult struct {
	...
	Meta   RadarAIInferenceTimeseriesGroupGetModelResponseResultMeta   `json:"meta" api:"required"`
	Serie0 RadarAIInferenceTimeseriesGroupGetModelResponseResultSerie0 `json:"serie_0" api:"required"`
...
type RadarAIInferenceTimeseriesGroupGetModelResponseResultMeta struct {
	...
	AggInterval    RadarAIInferenceTimeseriesGroupGetModelResponseResultMetaAggInterval    `json:"aggInterval" api:"required"`
	ConfidenceInfo RadarAIInferenceTimeseriesGroupGetModelResponseResultMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []RadarAIInferenceTimeseriesGroupGetModelResponseResultMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization RadarAIInferenceTimeseriesGroupGetModelResponseResultMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []RadarAIInferenceTimeseriesGroupGetModelResponseResultMetaUnit `json:"units" api:"required"`
...
type RadarAIInferenceTimeseriesGroupGetModelResponseResultMetaConfidenceInfo struct {
	Annotations []RadarAIInferenceTimeseriesGroupGetModelResponseResultMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
...
type RadarAIInferenceTimeseriesGroupGetTaskResponse struct {
	Result  RadarAIInferenceTimeseriesGroupGetTaskResponseResult `json:"result" api:"required"`
	Success bool                                                 `json:"success" api:"required"`
...
type RadarAIInferenceTimeseriesGroupGetTaskResponseResult struct {
	// Metadata for the results.
	Meta   RadarAIInferenceTimeseriesGroupGetTaskResponseResultMeta   `json:"meta" api:"required"`
	Serie0 RadarAIInferenceTimeseriesGroupGetTaskResponseResultSerie0 `json:"serie_0" api:"required"`
...
type RadarAIInferenceTimeseriesGroupGetTaskResponseResultMeta struct {
	...
	// Refer to
	// [Aggregation intervals](https://developers.cloudflare.com/radar/concepts/aggregation-intervals/).
	AggInterval    RadarAIInferenceTimeseriesGroupGetTaskResponseResultMetaAggInterval    `json:"aggInterval" api:"required"`
	ConfidenceInfo RadarAIInferenceTimeseriesGroupGetTaskResponseResultMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []RadarAIInferenceTimeseriesGroupGetTaskResponseResultMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization RadarAIInferenceTimeseriesGroupGetTaskResponseResultMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []RadarAIInferenceTimeseriesGroupGetTaskResponseResultMetaUnit `json:"units" api:"required"`
...
type RadarAIInferenceTimeseriesGroupGetTaskResponseResultMetaConfidenceInfo struct {
	Annotations []RadarAIInferenceTimeseriesGroupGetTaskResponseResultMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level int64                                                                      `json:"level" api:"required"`

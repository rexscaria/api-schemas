...
type RadarAttackLayer3GetTimeseriesResponse struct {
	Result  RadarAttackLayer3GetTimeseriesResponseResult `json:"result" api:"required"`
...
type RadarAttackLayer3GetTimeseriesResponseResult struct {
	...
	Meta        RadarAttackLayer3GetTimeseriesResponseResultMeta        `json:"meta" api:"required"`
	ExtraFields map[string]RadarAttackLayer3GetTimeseriesResponseResult `json:"-" api:"extrafields"`
...
type RadarAttackLayer3GetTimeseriesResponseResultMeta struct {
	...
	AggInterval    RadarAttackLayer3GetTimeseriesResponseResultMetaAggInterval    `json:"aggInterval" api:"required"`
	ConfidenceInfo RadarAttackLayer3GetTimeseriesResponseResultMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []RadarAttackLayer3GetTimeseriesResponseResultMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization RadarAttackLayer3GetTimeseriesResponseResultMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []RadarAttackLayer3GetTimeseriesResponseResultMetaUnit `json:"units" api:"required"`
...
type RadarAttackLayer3GetTimeseriesResponseResultMetaConfidenceInfo struct {
	Annotations []RadarAttackLayer3GetTimeseriesResponseResultMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`

...
func TestAccountTeamnetRouteListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.Teamnet.Routes.List(
		context.TODO(),
		"699d98642c564d2e855e9661899b7252",
		cfrex.AccountTeamnetRouteListParams{
			Comment:          cfrex.F("Example comment for this route."),
			ExistedAt:        cfrex.F("2019-10-12T07%3A20%3A50.52Z"),
			IsDeleted:        cfrex.F(true),
			NetworkSubset:    cfrex.F("172.16.0.0/16"),
			NetworkSuperset:  cfrex.F("172.16.0.0/16"),
			Page:             cfrex.F(1.000000),
			PerPage:          cfrex.F(1.000000),
			RouteID:          cfrex.F("f70ff985-a4ef-4643-bbbc-4a0ed4fc8415"),
			TunTypes:         cfrex.F([]cfrex.TunnelType{cfrex.TunnelTypeCfdTunnel}),
...
func TestAccountTeamnetRouteGetByIPWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.Teamnet.Routes.GetByIP(
		...
		"699d98642c564d2e855e9661899b7252",
		"10.1.0.137",
		cfrex.AccountTeamnetRouteGetByIPParams{
			DefaultVirtualNetworkFallback: cfrex.F(true),
			VirtualNetworkID:              cfrex.F("f70ff985-a4ef-4643-bbbc-4a0ed4fc8415"),
		},
	)
	if err != nil {

...
// interacting with the cf-rex API. You should not instantiate this client
...
func DefaultClientOptions() []option.RequestOption {
	...
	if o, ok := os.LookupEnv("CF_REX_API_KEY"); ok {
		defaults = append(defaults, option.WithAPIKey(o))
	}
	if o, ok := os.LookupEnv("CF_REX_ACCESS_TOKEN"); ok {
		defaults = append(defaults, option.WithAccessToken(o))
	}
	if o, ok := os.LookupEnv("CF_REX_SERVICE_KEY"); ok {
		defaults = append(defaults, option.WithServiceKey(o))
	}
	if o, ok := os.LookupEnv("CF_REX_CUSTOM_HEADERS"); ok {

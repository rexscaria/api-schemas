...
// the [NewZoneAPIGatewaySettingService] method instead.
type ZoneAPIGatewaySettingService struct {
	Options          []option.RequestOption
	SchemaValidation *ZoneAPIGatewaySettingSchemaValidationService
}
...
func NewZoneAPIGatewaySettingService(opts ...option.RequestOption) (r *ZoneAPIGatewaySettingService) {
	...
	r.Options = opts
	r.SchemaValidation = NewZoneAPIGatewaySettingSchemaValidationService(opts...)
	return
}

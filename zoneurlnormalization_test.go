...
func TestZoneURLNormalizationUpdate(t *testing.T) {
	...
	_, err := client.Zones.URLNormalization.Update(
		...
		cfrex.ZoneURLNormalizationUpdateParams{
			Scope: cfrex.F(cfrex.ZoneURLNormalizationUpdateParamsScopeIncoming),
			Type:  cfrex.F(cfrex.ZoneURLNormalizationUpdateParamsTypeCloudflare),
		},
	)
	if err != nil {
		var apierr *cfrex.Error

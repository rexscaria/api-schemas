...
type AccountAIRunCfMetaLlamaExecuteLlama2_7bChatHfLoraParamsBodyMessages struct {
	...
	Messages param.Field[[]AccountAIRunCfMetaLlamaExecuteLlama2_7bChatHfLoraParamsBodyMessagesMessage] `json:"messages" api:"required"`
	// Decreases the likelihood of the model repeating the same lines verbatim.
	FrequencyPenalty param.Field[float64]                                                                       `json:"frequency_penalty"`
...
type AccountAIRunCfMetaLlamaExecuteLlama2_7bChatHfLoraParamsBodyMessagesToolsObject struct {
	...
	Parameters param.Field[AccountAIRunCfMetaLlamaExecuteLlama2_7bChatHfLoraParamsBodyMessagesToolsObjectParameters] `json:"parameters" api:"required"`
}
...
type AccountAIRunCfMetaLlamaExecuteLlama2_7bChatHfLoraParamsBodyMessagesToolsObjectParameters struct {
	...
	Properties param.Field[map[string]AccountAIRunCfMetaLlamaExecuteLlama2_7bChatHfLoraParamsBodyMessagesToolsObjectParametersProperties] `json:"properties" api:"required"`

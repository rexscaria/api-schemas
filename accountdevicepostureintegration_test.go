...
func TestAccountDevicePostureIntegrationNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.Devices.Posture.Integration.New(
		...
		cfrex.AccountDevicePostureIntegrationNewParams{
			Config: cfrex.F[cfrex.ConfigRequestIntegrationUnionParam](cfrex.ConfigRequestIntegrationTeamsDevicesWorkspaceOneConfigRequestParam{
				APIURL:       cfrex.F("https://as123.awmdm.com/API"),
				AuthURL:      cfrex.F("https://na.uemauth.vmwservices.com/connect/token"),
				ClientID:     cfrex.F("example client id"),
				ClientSecret: cfrex.F("example client secret"),
			}),
			Interval: cfrex.F("10m"),
			Name:     cfrex.F("My Workspace One Integration"),
			Type:     cfrex.F(cfrex.DeviceTypePostureIntegrationWorkspaceOne),
		},
	)
	if err != nil {
...
func TestAccountDevicePostureIntegrationUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.Devices.Posture.Integration.Update(
		...
		"699d98642c564d2e855e9661899b7252",
		"f174e90a-fafe-4643-bbbc-4a0ed4fc8415",
		cfrex.AccountDevicePostureIntegrationUpdateParams{
			Config: cfrex.F[cfrex.ConfigRequestIntegrationUnionParam](cfrex.ConfigRequestIntegrationTeamsDevicesWorkspaceOneConfigRequestParam{
				APIURL:       cfrex.F("https://as123.awmdm.com/API"),
				AuthURL:      cfrex.F("https://na.uemauth.vmwservices.com/connect/token"),
				ClientID:     cfrex.F("example client id"),
...
func TestAccountDevicePostureIntegrationDelete(t *testing.T) {
	...
	_, err := client.Accounts.Devices.Posture.Integration.Delete(
		...
		"699d98642c564d2e855e9661899b7252",
		"f174e90a-fafe-4643-bbbc-4a0ed4fc8415",
		cfrex.AccountDevicePostureIntegrationDeleteParams{

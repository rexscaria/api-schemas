...
type RadarAttackLayer7GetTimeseriesResponse struct {
	Result  RadarAttackLayer7GetTimeseriesResponseResult `json:"result" api:"required"`
...
type RadarAttackLayer7GetTimeseriesResponseResult struct {
	...
	Meta   RadarAttackLayer7GetTimeseriesResponseResultMeta   `json:"meta" api:"required"`
	Serie0 RadarAttackLayer7GetTimeseriesResponseResultSerie0 `json:"serie_0" api:"required"`
...
type RadarAttackLayer7GetTimeseriesResponseResultMeta struct {
	...
	AggInterval    RadarAttackLayer7GetTimeseriesResponseResultMetaAggInterval    `json:"aggInterval" api:"required"`
	ConfidenceInfo RadarAttackLayer7GetTimeseriesResponseResultMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []RadarAttackLayer7GetTimeseriesResponseResultMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization RadarAttackLayer7GetTimeseriesResponseResultMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []RadarAttackLayer7GetTimeseriesResponseResultMetaUnit `json:"units" api:"required"`
...
type RadarAttackLayer7GetTimeseriesResponseResultMetaConfidenceInfo struct {
	Annotations []RadarAttackLayer7GetTimeseriesResponseResultMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`

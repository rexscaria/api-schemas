...
// AccountAIRunCfStabilityaiService contains methods and other services that help
// with interacting with the cf-rex API.
//
// Note, unlike clients, this service does not read variables from the environment
// automatically. You should not instantiate this service directly, and instead use
// the [NewAccountAIRunCfStabilityaiService] method instead.
type AccountAIRunCfStabilityaiService struct {
	Options []option.RequestOption
}

// NewAccountAIRunCfStabilityaiService generates a new service that applies the
// given options to each request. These options are applied after the parent
// client's options (if there is one), and before any request-specific options.
func NewAccountAIRunCfStabilityaiService(opts ...option.RequestOption) (r *AccountAIRunCfStabilityaiService) {
	r = &AccountAIRunCfStabilityaiService{}
	r.Options = opts
	return
}
...
func (r AccountAIRunCfStabilityaiExecuteStableDiffusionXlBase1_0Params) MarshalJSON() (data []byte, err error) {
	return apijson.MarshalRoot(r)
}

// URLQuery serializes
// [AccountAIRunCfStabilityaiExecuteStableDiffusionXlBase1_0Params]'s query
// parameters as `url.Values`.
func (r AccountAIRunCfStabilityaiExecuteStableDiffusionXlBase1_0Params) URLQuery() (v url.Values) {

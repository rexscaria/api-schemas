...
func TestZoneLogpushJobNewJobWithOptionalParams(t *testing.T) {
	...
	_, err := client.Zones.Logpush.Jobs.NewJob(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cfrex.ZoneLogpushJobNewJobParams{
			DestinationConf:          cfrex.F("s3://mybucket/logs?region=us-west-2"),
			Dataset:                  cfrex.F("http_requests"),
			...
			OutputOptions: cfrex.F(cfrex.OutputOptionsParam{
				...
				FieldNames:      cfrex.F([]string{"RayID", "ClientIP", "EdgeStartTimestamp"}),
...
func TestZoneLogpushJobDeleteJob(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Zones.Logpush.Jobs.DeleteJob(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		int64(1),
		cfrex.ZoneLogpushJobDeleteJobParams{
...
func TestZoneLogpushJobListJobs(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Zones.Logpush.Jobs.ListJobs(context.TODO(), "023e105f4ecef8ad9ca31a8372d0c353")
	if err != nil {
		var apierr *cfrex.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestZoneLogpushJobGetJob(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Zones.Logpush.Jobs.GetJob(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		int64(1),
	)
...
func TestZoneLogpushJobUpdateJobWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Zones.Logpush.Jobs.UpdateJob(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		int64(1),
		cfrex.ZoneLogpushJobUpdateJobParams{
			DestinationConf:          cfrex.F("s3://mybucket/logs?region=us-west-2"),
			Enabled:                  cfrex.F(false),
			Frequency:                cfrex.F(cfrex.FrequencyHigh),
			Kind:                     cfrex.F(cfrex.LogpushKindEdge),

...
type AccountAIRunHfMetaLlamaExecuteMetaLlama3_8bInstructParamsBodyMessages struct {
	...
	Messages param.Field[[]AccountAIRunHfMetaLlamaExecuteMetaLlama3_8bInstructParamsBodyMessagesMessage] `json:"messages" api:"required"`
	// Decreases the likelihood of the model repeating the same lines verbatim.
	FrequencyPenalty param.Field[float64]                                                                         `json:"frequency_penalty"`
...
type AccountAIRunHfMetaLlamaExecuteMetaLlama3_8bInstructParamsBodyMessagesToolsObject struct {
	...
	Parameters param.Field[AccountAIRunHfMetaLlamaExecuteMetaLlama3_8bInstructParamsBodyMessagesToolsObjectParameters] `json:"parameters" api:"required"`
}
...
type AccountAIRunHfMetaLlamaExecuteMetaLlama3_8bInstructParamsBodyMessagesToolsObjectParameters struct {
	...
	Properties param.Field[map[string]AccountAIRunHfMetaLlamaExecuteMetaLlama3_8bInstructParamsBodyMessagesToolsObjectParametersProperties] `json:"properties" api:"required"`

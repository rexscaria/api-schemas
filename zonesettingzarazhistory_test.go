...
func TestZoneSettingZarazHistoryListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Zones.Settings.Zaraz.History.List(
		...
		cfrex.ZoneSettingZarazHistoryListParams{
			Limit:     cfrex.F(int64(1)),
			Offset:    cfrex.F(int64(0)),
			SortField: cfrex.F(cfrex.ZoneSettingZarazHistoryListParamsSortFieldID),
			SortOrder: cfrex.F(cfrex.ZoneSettingZarazHistoryListParamsSortOrderDesc),
		},
	)
	if err != nil {
...
func TestZoneSettingZarazHistoryRestore(t *testing.T) {
	...
	_, err := client.Zones.Settings.Zaraz.History.Restore(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cfrex.ZoneSettingZarazHistoryRestoreParams{
			Body: int64(12345),
		},
	)
	if err != nil {
...
func TestZoneSettingZarazHistoryGetConfigs(t *testing.T) {
	...
	_, err := client.Zones.Settings.Zaraz.History.GetConfigs(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cfrex.ZoneSettingZarazHistoryGetConfigsParams{
			IDs: cfrex.F([]int64{int64(0)}),
		},
	)
	if err != nil {
		var apierr *cfrex.Error

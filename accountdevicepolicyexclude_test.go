...
func TestAccountDevicePolicyExcludeGlobalSet(t *testing.T) {
	...
	_, err := client.Accounts.Devices.Policy.Exclude.GlobalSet(
		context.TODO(),
		"699d98642c564d2e855e9661899b7252",
		cfrex.AccountDevicePolicyExcludeGlobalSetParams{
			Body: []cfrex.SplitTunnelUnionParam{cfrex.SplitTunnelTeamsDevicesExcludeSplitTunnelWithAddressParam{
...
func TestAccountDevicePolicyExcludeSet(t *testing.T) {
	...
	_, err := client.Accounts.Devices.Policy.Exclude.Set(
		...
		"699d98642c564d2e855e9661899b7252",
		"f174e90a-fafe-4643-bbbc-4a0ed4fc8415",
		cfrex.AccountDevicePolicyExcludeSetParams{
			Body: []cfrex.SplitTunnelUnionParam{cfrex.SplitTunnelTeamsDevicesExcludeSplitTunnelWithAddressParam{
				Address:     cfrex.F("192.0.2.0/24"),
				Description: cfrex.F("Exclude testing domains from the tunnel"),
			}},

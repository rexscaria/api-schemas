...
func TestRadarBgpTopAseListTopAsesWithOptionalParams(t *testing.T) {
	...
	_, err := client.Radar.Bgp.Top.Ases.ListTopAses(context.TODO(), cfrex.RadarBgpTopAseListTopAsesParams{
		...
		Format:     cfrex.F(cfrex.RadarBgpTopAseListTopAsesParamsFormatJson),
		Limit:      cfrex.F(int64(5)),
		Name:       cfrex.F([]string{"main_series"}),
		Prefix:     cfrex.F([]string{"1.1.1.0/24"}),
		UpdateType: cfrex.F([]cfrex.RadarBgpTopAseListTopAsesParamsUpdateType{cfrex.RadarBgpTopAseListTopAsesParamsUpdateTypeAnnouncement}),
	})
	if err != nil {
...
func TestRadarBgpTopAseListTopPrefixesWithOptionalParams(t *testing.T) {
	...
	_, err := client.Radar.Bgp.Top.Ases.ListTopPrefixes(context.TODO(), cfrex.RadarBgpTopAseListTopPrefixesParams{
		Country: cfrex.F("NZ"),
		Format:  cfrex.F(cfrex.RadarBgpTopAseListTopPrefixesParamsFormatJson),

...
func TestMembershipUpdate(t *testing.T) {
	...
	_, err := client.Memberships.Update(
		...
		cfrex.MembershipUpdateParams{
			Status: cfrex.F(cfrex.MembershipUpdateParamsStatusAccepted),
		},
	)
	if err != nil {
		var apierr *cfrex.Error
...
func TestMembershipListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Memberships.List(context.TODO(), cfrex.MembershipListParams{

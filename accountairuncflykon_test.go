...
func TestAccountAIRunCfLykonExecuteDreamshaper8LcmWithOptionalParams(t *testing.T) {
	...
	resp, err := client.Accounts.AI.Run.Cf.Lykon.ExecuteDreamshaper8Lcm(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cfrex.AccountAIRunCfLykonExecuteDreamshaper8LcmParams{
			Prompt:         cfrex.F("x"),

...
func TestAccountWorkerDispatchNamespaceScriptSettingPatchWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Accounts.Workers.Dispatch.Namespaces.Scripts.Settings.Patch(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		"my-dispatch-namespace",
		"this-is_my_script-01",
		cfrex.AccountWorkerDispatchNamespaceScriptSettingPatchParams{

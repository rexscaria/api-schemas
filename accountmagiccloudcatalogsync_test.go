...
func TestAccountMagicCloudCatalogSyncNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.Magic.Cloud.CatalogSyncs.New(
		context.TODO(),
		"account_id",
		cfrex.AccountMagicCloudCatalogSyncNewParams{
			DestinationType: cfrex.F(cfrex.McnCatalogSyncDestinationTypeNone),
			Name:            cfrex.F("name"),
			UpdateMode:      cfrex.F(cfrex.McnCatalogSyncUpdateModeAuto),
...
func TestAccountMagicCloudCatalogSyncUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.Magic.Cloud.CatalogSyncs.Update(
		...
		"account_id",
		"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
		cfrex.AccountMagicCloudCatalogSyncUpdateParams{
			McnUpdateCatalogSyncRequest: cfrex.McnUpdateCatalogSyncRequestParam{
				Description: cfrex.F("description"),
				Name:        cfrex.F("name"),
				Policy:      cfrex.F("policy"),
				UpdateMode:  cfrex.F(cfrex.McnCatalogSyncUpdateModeAuto),
...
func TestAccountMagicCloudCatalogSyncDeleteWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.Magic.Cloud.CatalogSyncs.Delete(
		...
		"account_id",
		"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
		cfrex.AccountMagicCloudCatalogSyncDeleteParams{
			DeleteDestination: cfrex.F(true),
		},
	)
	if err != nil {
		var apierr *cfrex.Error
...
func TestAccountMagicCloudCatalogSyncListPoliciesWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.Magic.Cloud.CatalogSyncs.ListPolicies(
		context.TODO(),
		"account_id",
		cfrex.AccountMagicCloudCatalogSyncListPoliciesParams{
			DestinationType: cfrex.F(cfrex.McnCatalogSyncDestinationTypeNone),
		},
	)
	if err != nil {
...
func TestAccountMagicCloudCatalogSyncPatchWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.Magic.Cloud.CatalogSyncs.Patch(
		...
		"account_id",
		"182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e",
		cfrex.AccountMagicCloudCatalogSyncPatchParams{
			McnUpdateCatalogSyncRequest: cfrex.McnUpdateCatalogSyncRequestParam{
				Description: cfrex.F("description"),
				Name:        cfrex.F("name"),
				Policy:      cfrex.F("policy"),

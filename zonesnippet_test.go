...
func TestZoneSnippetGetContent(t *testing.T) {
	t.Skip("skipped: currently no good way to test endpoints with content type multipart/form-data, Prism mock server will fail")

...
type RadarNetflowGetSummaryResponse struct {
	Result  RadarNetflowGetSummaryResponseResult `json:"result" api:"required"`
...
type RadarNetflowGetSummaryResponseResult struct {
	...
	Meta     RadarNetflowGetSummaryResponseResultMeta     `json:"meta" api:"required"`
	Summary0 RadarNetflowGetSummaryResponseResultSummary0 `json:"summary_0" api:"required"`
...
type RadarNetflowGetSummaryResponseResultMeta struct {
	ConfidenceInfo RadarNetflowGetSummaryResponseResultMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []RadarNetflowGetSummaryResponseResultMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization RadarNetflowGetSummaryResponseResultMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []RadarNetflowGetSummaryResponseResultMetaUnit `json:"units" api:"required"`
...
type RadarNetflowGetSummaryResponseResultMetaConfidenceInfo struct {
	Annotations []RadarNetflowGetSummaryResponseResultMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
...
type RadarNetflowGetTimeseriesResponse struct {
	Result  RadarNetflowGetTimeseriesResponseResult `json:"result" api:"required"`
	Success bool                                    `json:"success" api:"required"`
...
type RadarNetflowGetTimeseriesResponseResult struct {
	// Metadata for the results.
	Meta   RadarNetflowGetTimeseriesResponseResultMeta   `json:"meta" api:"required"`
	Serie0 RadarNetflowGetTimeseriesResponseResultSerie0 `json:"serie_0" api:"required"`
...
type RadarNetflowGetTimeseriesResponseResultMeta struct {
	...
	AggInterval    RadarNetflowGetTimeseriesResponseResultMetaAggInterval    `json:"aggInterval" api:"required"`
	ConfidenceInfo RadarNetflowGetTimeseriesResponseResultMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []RadarNetflowGetTimeseriesResponseResultMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization RadarNetflowGetTimeseriesResponseResultMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []RadarNetflowGetTimeseriesResponseResultMetaUnit `json:"units" api:"required"`
...
type RadarNetflowGetTimeseriesResponseResultMetaConfidenceInfo struct {
	Annotations []RadarNetflowGetTimeseriesResponseResultMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level int64                                                         `json:"level" api:"required"`

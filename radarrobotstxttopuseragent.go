...
type RadarRobotsTxtTopUserAgentGetTopUserAgentsResponse struct {
	Result  RadarRobotsTxtTopUserAgentGetTopUserAgentsResponseResult `json:"result" api:"required"`
...
type RadarRobotsTxtTopUserAgentGetTopUserAgentsResponseResult struct {
	...
	Meta RadarRobotsTxtTopUserAgentGetTopUserAgentsResponseResultMeta   `json:"meta" api:"required"`
	Top0 []RadarRobotsTxtTopUserAgentGetTopUserAgentsResponseResultTop0 `json:"top_0" api:"required"`
...
type RadarRobotsTxtTopUserAgentGetTopUserAgentsResponseResultMeta struct {
	ConfidenceInfo RadarRobotsTxtTopUserAgentGetTopUserAgentsResponseResultMetaConfidenceInfo `json:"confidenceInfo" api:"required,nullable"`
	DateRange      []RadarRobotsTxtTopUserAgentGetTopUserAgentsResponseResultMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization RadarRobotsTxtTopUserAgentGetTopUserAgentsResponseResultMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []RadarRobotsTxtTopUserAgentGetTopUserAgentsResponseResultMetaUnit `json:"units" api:"required"`
...
type RadarRobotsTxtTopUserAgentGetTopUserAgentsResponseResultMetaConfidenceInfo struct {
	Annotations []RadarRobotsTxtTopUserAgentGetTopUserAgentsResponseResultMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`

...
func TestRadarDNSGetTimeseriesWithOptionalParams(t *testing.T) {
	...
	_, err := client.Radar.DNS.GetTimeseries(context.TODO(), cfrex.RadarDNSGetTimeseriesParams{
		...
		Format:       cfrex.F(cfrex.RadarDNSGetTimeseriesParamsFormatJson),
		Location:     cfrex.F([]string{"string"}),
		Name:         cfrex.F([]string{"main_series"}),
		Nodata:       cfrex.F(true),
		Protocol:     cfrex.F(cfrex.RadarDNSGetTimeseriesParamsProtocolUdp),
		QueryType:    cfrex.F(cfrex.RadarDNSGetTimeseriesParamsQueryTypeA),
		ResponseCode: cfrex.F(cfrex.RadarDNSGetTimeseriesParamsResponseCodeNoerror),

...
type AccountAIRunHfGoogleExecuteGemma7bItParamsBodyMessages struct {
	...
	Messages param.Field[[]AccountAIRunHfGoogleExecuteGemma7bItParamsBodyMessagesMessage] `json:"messages" api:"required"`
	// Decreases the likelihood of the model repeating the same lines verbatim.
	FrequencyPenalty param.Field[float64]                                                          `json:"frequency_penalty"`
...
type AccountAIRunHfGoogleExecuteGemma7bItParamsBodyMessagesToolsObject struct {
	...
	Parameters param.Field[AccountAIRunHfGoogleExecuteGemma7bItParamsBodyMessagesToolsObjectParameters] `json:"parameters" api:"required"`
}
...
type AccountAIRunHfGoogleExecuteGemma7bItParamsBodyMessagesToolsObjectParameters struct {
	...
	Properties param.Field[map[string]AccountAIRunHfGoogleExecuteGemma7bItParamsBodyMessagesToolsObjectParametersProperties] `json:"properties" api:"required"`

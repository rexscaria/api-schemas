...
func TestAccountAIRunCfFblgitExecuteUnaCybertron7bV2Bf16WithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.AI.Run.Cf.Fblgit.ExecuteUnaCybertron7bV2Bf16(
		...
		cfrex.AccountAIRunCfFblgitExecuteUnaCybertron7bV2Bf16Params{
			...
			Body: cfrex.AccountAIRunCfFblgitExecuteUnaCybertron7bV2Bf16ParamsBodyPrompt{
				...
				ResponseFormat: cfrex.F(cfrex.AccountAIRunCfFblgitExecuteUnaCybertron7bV2Bf16ParamsBodyPromptResponseFormat{
					...
					Type:       cfrex.F(cfrex.AccountAIRunCfFblgitExecuteUnaCybertron7bV2Bf16ParamsBodyPromptResponseFormatTypeJsonObject),
				}),

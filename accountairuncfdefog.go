...
type AccountAIRunCfDefogExecuteSqlcoder7b2ParamsBodyMessages struct {
	...
	Messages param.Field[[]AccountAIRunCfDefogExecuteSqlcoder7b2ParamsBodyMessagesMessage] `json:"messages" api:"required"`
	// Decreases the likelihood of the model repeating the same lines verbatim.
	FrequencyPenalty param.Field[float64]                                                           `json:"frequency_penalty"`
...
type AccountAIRunCfDefogExecuteSqlcoder7b2ParamsBodyMessagesToolsObject struct {
	...
	Parameters param.Field[AccountAIRunCfDefogExecuteSqlcoder7b2ParamsBodyMessagesToolsObjectParameters] `json:"parameters" api:"required"`
}
...
type AccountAIRunCfDefogExecuteSqlcoder7b2ParamsBodyMessagesToolsObjectParameters struct {
	...
	Properties param.Field[map[string]AccountAIRunCfDefogExecuteSqlcoder7b2ParamsBodyMessagesToolsObjectParametersProperties] `json:"properties" api:"required"`

...
type RadarLeakedCredentialCheckSummaryGetByBotClassResponse struct {
	Result  RadarLeakedCredentialCheckSummaryGetByBotClassResponseResult `json:"result" api:"required"`
...
type RadarLeakedCredentialCheckSummaryGetByBotClassResponseResult struct {
	...
	Meta     RadarLeakedCredentialCheckSummaryGetByBotClassResponseResultMeta     `json:"meta" api:"required"`
	Summary0 RadarLeakedCredentialCheckSummaryGetByBotClassResponseResultSummary0 `json:"summary_0" api:"required"`
...
type RadarLeakedCredentialCheckSummaryGetByBotClassResponseResultMeta struct {
	ConfidenceInfo RadarLeakedCredentialCheckSummaryGetByBotClassResponseResultMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []RadarLeakedCredentialCheckSummaryGetByBotClassResponseResultMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization RadarLeakedCredentialCheckSummaryGetByBotClassResponseResultMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []RadarLeakedCredentialCheckSummaryGetByBotClassResponseResultMetaUnit `json:"units" api:"required"`
...
type RadarLeakedCredentialCheckSummaryGetByBotClassResponseResultMetaConfidenceInfo struct {
	Annotations []RadarLeakedCredentialCheckSummaryGetByBotClassResponseResultMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
...
type RadarLeakedCredentialCheckSummaryGetByCompromisedStatusResponse struct {
	Result  RadarLeakedCredentialCheckSummaryGetByCompromisedStatusResponseResult `json:"result" api:"required"`
	Success bool                                                                  `json:"success" api:"required"`
...
type RadarLeakedCredentialCheckSummaryGetByCompromisedStatusResponseResult struct {
	// Metadata for the results.
	Meta     RadarLeakedCredentialCheckSummaryGetByCompromisedStatusResponseResultMeta     `json:"meta" api:"required"`
	Summary0 RadarLeakedCredentialCheckSummaryGetByCompromisedStatusResponseResultSummary0 `json:"summary_0" api:"required"`
...
type RadarLeakedCredentialCheckSummaryGetByCompromisedStatusResponseResultMeta struct {
	ConfidenceInfo RadarLeakedCredentialCheckSummaryGetByCompromisedStatusResponseResultMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []RadarLeakedCredentialCheckSummaryGetByCompromisedStatusResponseResultMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization RadarLeakedCredentialCheckSummaryGetByCompromisedStatusResponseResultMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []RadarLeakedCredentialCheckSummaryGetByCompromisedStatusResponseResultMetaUnit `json:"units" api:"required"`
...
type RadarLeakedCredentialCheckSummaryGetByCompromisedStatusResponseResultMetaConfidenceInfo struct {
	Annotations []RadarLeakedCredentialCheckSummaryGetByCompromisedStatusResponseResultMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`
	// Provides an indication of how much confidence Cloudflare has in the data.
	Level int64                                                                                       `json:"level" api:"required"`

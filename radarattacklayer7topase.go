...
// Normalization method applied to the results. Refer to
// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
type RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalization string

const (
	RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalizationPercentage           RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalization = "PERCENTAGE"
	RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalizationMin0Max              RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalization = "MIN0_MAX"
	RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalizationMinMax               RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalization = "MIN_MAX"
	RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalizationRawValues            RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalization = "RAW_VALUES"
	RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalizationPercentageChange     RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalization = "PERCENTAGE_CHANGE"
	RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalizationRollingAverage       RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalization = "ROLLING_AVERAGE"
	RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalizationOverlappedPercentage RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalization = "OVERLAPPED_PERCENTAGE"
	RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalizationRatio                RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalization = "RATIO"
)

func (r RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalization) IsKnown() bool {
	switch r {
	case RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalizationPercentage, RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalizationMin0Max, RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalizationMinMax, RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalizationRawValues, RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalizationPercentageChange, RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalizationRollingAverage, RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalizationOverlappedPercentage, RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaNormalizationRatio:
		return true
	}
	return false
}
...
// radarAttackLayer7TopAseGetTopOriginAsResponseResultMetaUnitJSON contains the
// JSON metadata for the struct
// [RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaUnit]
type radarAttackLayer7TopAseGetTopOriginAsResponseResultMetaUnitJSON struct {
	Name        apijson.Field
	Value       apijson.Field
	raw         string
	ExtraFields map[string]apijson.Field
...
func (r *RadarAttackLayer7TopAseGetTopOriginAsResponseResultMetaUnit) UnmarshalJSON(data []byte) (err error) {
	return apijson.UnmarshalRoot(data, r)
}

func (r radarAttackLayer7TopAseGetTopOriginAsResponseResultMetaUnitJSON) RawJSON() string {
	return r.raw
}

...
type RadarAIBotTimeseriesGroupGetUserAgentResponse struct {
	Result  RadarAIBotTimeseriesGroupGetUserAgentResponseResult `json:"result" api:"required"`
...
type RadarAIBotTimeseriesGroupGetUserAgentResponseResult struct {
	...
	Meta   RadarAIBotTimeseriesGroupGetUserAgentResponseResultMeta   `json:"meta" api:"required"`
	Serie0 RadarAIBotTimeseriesGroupGetUserAgentResponseResultSerie0 `json:"serie_0" api:"required"`
...
type RadarAIBotTimeseriesGroupGetUserAgentResponseResultMeta struct {
	...
	AggInterval    RadarAIBotTimeseriesGroupGetUserAgentResponseResultMetaAggInterval    `json:"aggInterval" api:"required"`
	ConfidenceInfo RadarAIBotTimeseriesGroupGetUserAgentResponseResultMetaConfidenceInfo `json:"confidenceInfo" api:"required"`
	DateRange      []RadarAIBotTimeseriesGroupGetUserAgentResponseResultMetaDateRange    `json:"dateRange" api:"required"`
	// Timestamp of the last dataset update.
	LastUpdated time.Time `json:"lastUpdated" api:"required" format:"date-time"`
	// Normalization method applied to the results. Refer to
	// [Normalization methods](https://developers.cloudflare.com/radar/concepts/normalization/).
	Normalization RadarAIBotTimeseriesGroupGetUserAgentResponseResultMetaNormalization `json:"normalization" api:"required"`
	// Measurement units for the results.
	Units []RadarAIBotTimeseriesGroupGetUserAgentResponseResultMetaUnit `json:"units" api:"required"`
...
type RadarAIBotTimeseriesGroupGetUserAgentResponseResultMetaConfidenceInfo struct {
	Annotations []RadarAIBotTimeseriesGroupGetUserAgentResponseResultMetaConfidenceInfoAnnotation `json:"annotations" api:"required"`

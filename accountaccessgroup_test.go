...
func TestAccountAccessGroupNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.Access.Groups.New(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cfrex.AccountAccessGroupNewParams{
...
func TestAccountAccessGroupUpdateWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.Access.Groups.Update(
		...
		"023e105f4ecef8ad9ca31a8372d0c353",
		"f174e90a-fafe-4643-bbbc-4a0ed4fc8415",
		cfrex.AccountAccessGroupUpdateParams{
			Include: cfrex.F([]cfrex.AccessRuleUnionParam{cfrex.AccessRuleAccessAccessGroupRuleParam{
				Group: cfrex.F(cfrex.AccessRuleAccessAccessGroupRuleGroupParam{
					ID: cfrex.F("aa0a4aab-672b-4bdb-bc33-a59f1130a11f"),
				}),
...
func TestAccountAccessGroupListWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Accounts.Access.Groups.List(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cfrex.AccountAccessGroupListParams{
			Name:   cfrex.F("name"),

...
func TestRadarEntityAsnGetWithOptionalParams(t *testing.T) {
	...
	_, err := client.Radar.Entities.Asns.Get(
		context.TODO(),
		int64(174),
		cfrex.RadarEntityAsnGetParams{
			Format: cfrex.F(cfrex.RadarEntityAsnGetParamsFormatJson),
		},
	)
	if err != nil {
...
func TestRadarEntityAsnListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Radar.Entities.Asns.List(context.TODO(), cfrex.RadarEntityAsnListParams{
		...
		Format:   cfrex.F(cfrex.RadarEntityAsnListParamsFormatJson),
		Limit:    cfrex.F(int64(5)),
		Location: cfrex.F("US"),
		Offset:   cfrex.F(int64(0)),
		OrderBy:  cfrex.F(cfrex.RadarEntityAsnListParamsOrderByAsn),
	})
	if err != nil {
		var apierr *cfrex.Error
		if errors.As(err, &apierr) {
...
func TestRadarEntityAsnGetRelationshipsWithOptionalParams(t *testing.T) {
	...
	_, err := client.Radar.Entities.Asns.GetRelationships(
		context.TODO(),
		int64(3),
		cfrex.RadarEntityAsnGetRelationshipsParams{
			Asn2:   cfrex.F(int64(0)),
			Format: cfrex.F(cfrex.RadarEntityAsnGetRelationshipsParamsFormatJson),
		},
	)
	if err != nil {
		var apierr *cfrex.Error
...
func TestRadarEntityAsnGetByIPWithOptionalParams(t *testing.T) {
	...
	_, err := client.Radar.Entities.Asns.GetByIP(context.TODO(), cfrex.RadarEntityAsnGetByIPParams{
		IP:     cfrex.F("8.8.8.8"),
		Format: cfrex.F(cfrex.RadarEntityAsnGetByIPParamsFormatJson),
	})
	if err != nil {
		var apierr *cfrex.Error
		if errors.As(err, &apierr) {

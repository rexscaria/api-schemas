...
func TestAccountD1DatabaseNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.D1.Database.New(
		...
		cfrex.AccountD1DatabaseNewParams{
			Name:                cfrex.F("my-database"),
			PrimaryLocationHint: cfrex.F(cfrex.AccountD1DatabaseNewParamsPrimaryLocationHintWnam),
		},
	)
	if err != nil {
...
func TestAccountD1DatabaseListWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.D1.Database.List(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cfrex.AccountD1DatabaseListParams{
			Name:    cfrex.F("name"),
...
func TestAccountD1DatabaseExportWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.D1.Database.Export(
		...
		"023e105f4ecef8ad9ca31a8372d0c353",
		"xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
		cfrex.AccountD1DatabaseExportParams{
			OutputFormat:    cfrex.F(cfrex.AccountD1DatabaseExportParamsOutputFormatPolling),
			CurrentBookmark: cfrex.F("current_bookmark"),
			DumpOptions: cfrex.F(cfrex.AccountD1DatabaseExportParamsDumpOptions{
				NoData:   cfrex.F(true),
				NoSchema: cfrex.F(true),
				Tables:   cfrex.F([]string{"string"}),
			}),
		},
	)
	if err != nil {
...
func TestAccountD1DatabaseQueryWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.D1.Database.Query(
		...
		"023e105f4ecef8ad9ca31a8372d0c353",
		"xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
		cfrex.AccountD1DatabaseQueryParams{
			Sql:    cfrex.F("SELECT * FROM myTable WHERE field = ? OR field = ?;"),
			Params: cfrex.F([]string{"firstParam", "secondParam"}),
		},
	)
	if err != nil {
		var apierr *cfrex.Error
...
func TestAccountD1DatabaseRawQueryWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.D1.Database.RawQuery(
		...
		"023e105f4ecef8ad9ca31a8372d0c353",
		"xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx",
		cfrex.AccountD1DatabaseRawQueryParams{
			Sql:    cfrex.F("SELECT * FROM myTable WHERE field = ? OR field = ?;"),
			Params: cfrex.F([]string{"firstParam", "secondParam"}),
		},
	)

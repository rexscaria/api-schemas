...
func TestAccountAIRunCfGoogleExecuteGemma2bItLoraWithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.AI.Run.Cf.Google.ExecuteGemma2bItLora(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cfrex.AccountAIRunCfGoogleExecuteGemma2bItLoraParams{
			...
			Body: cfrex.AccountAIRunCfGoogleExecuteGemma2bItLoraParamsBodyPrompt{
				...
				ResponseFormat: cfrex.F(cfrex.AccountAIRunCfGoogleExecuteGemma2bItLoraParamsBodyPromptResponseFormat{
					...
					Type:       cfrex.F(cfrex.AccountAIRunCfGoogleExecuteGemma2bItLoraParamsBodyPromptResponseFormatTypeJsonObject),
				}),
...
func TestAccountAIRunCfGoogleExecuteGemma7bItLoraWithOptionalParams(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Accounts.AI.Run.Cf.Google.ExecuteGemma7bItLora(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cfrex.AccountAIRunCfGoogleExecuteGemma7bItLoraParams{
			QueueRequest: cfrex.F("true"),
			Body: cfrex.AccountAIRunCfGoogleExecuteGemma7bItLoraParamsBodyPrompt{
				...
				ResponseFormat: cfrex.F(cfrex.AccountAIRunCfGoogleExecuteGemma7bItLoraParamsBodyPromptResponseFormat{
					JsonSchema: cfrex.F[any](map[string]interface{}{}),
					Type:       cfrex.F(cfrex.AccountAIRunCfGoogleExecuteGemma7bItLoraParamsBodyPromptResponseFormatTypeJsonObject),
				}),
				Seed:        cfrex.F(int64(1)),
				Stream:      cfrex.F(true),
				Temperature: cfrex.F(0.000000),

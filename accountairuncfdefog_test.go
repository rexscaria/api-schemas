...
func TestAccountAIRunCfDefogExecuteSqlcoder7b2WithOptionalParams(t *testing.T) {
	...
	_, err := client.Accounts.AI.Run.Cf.Defog.ExecuteSqlcoder7b2(
		context.TODO(),
		"023e105f4ecef8ad9ca31a8372d0c353",
		cfrex.AccountAIRunCfDefogExecuteSqlcoder7b2Params{
			...
			Body: cfrex.AccountAIRunCfDefogExecuteSqlcoder7b2ParamsBodyPrompt{
				...
				ResponseFormat: cfrex.F(cfrex.AccountAIRunCfDefogExecuteSqlcoder7b2ParamsBodyPromptResponseFormat{
					...
					Type:       cfrex.F(cfrex.AccountAIRunCfDefogExecuteSqlcoder7b2ParamsBodyPromptResponseFormatTypeJsonObject),
				}),

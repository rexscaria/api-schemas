...
func TestZoneRulesetVersionList(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Zones.Rulesets.Versions.List(
		context.TODO(),
		"9f1839b6152d298aca64c4e906b6d074",
		"2f2feab2026849078ba485f918791bdc",
	)
...
func TestZoneRulesetVersionListByTag(t *testing.T) {
	t.Skip("skipped: tests are disabled for the time being")
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	...
	_, err := client.Zones.Rulesets.Versions.ListByTag(
		context.TODO(),
		"9f1839b6152d298aca64c4e906b6d074",
		"2f2feab2026849078ba485f918791bdc",
		"1",

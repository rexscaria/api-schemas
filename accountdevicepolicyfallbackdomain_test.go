...
func TestAccountDevicePolicyFallbackDomainGlobalSet(t *testing.T) {
	...
	_, err := client.Accounts.Devices.Policy.FallbackDomains.GlobalSet(
		context.TODO(),
		"699d98642c564d2e855e9661899b7252",
		cfrex.AccountDevicePolicyFallbackDomainGlobalSetParams{
			Body: []cfrex.FallbackDomainParam{{
				Suffix:      cfrex.F("example.com"),
				Description: cfrex.F("Domain bypass for local development"),
				DNSServer:   cfrex.F([]string{"1.1.1.1"}),
			}},
		},
	)
	if err != nil {
...
func TestAccountDevicePolicyFallbackDomainSet(t *testing.T) {
	...
	_, err := client.Accounts.Devices.Policy.FallbackDomains.Set(
		...
		"699d98642c564d2e855e9661899b7252",
		"f174e90a-fafe-4643-bbbc-4a0ed4fc8415",
		cfrex.AccountDevicePolicyFallbackDomainSetParams{
			Body: []cfrex.FallbackDomainParam{{
				Suffix:      cfrex.F("example.com"),
				Description: cfrex.F("Domain bypass for local development"),
				DNSServer:   cfrex.F([]string{"1.1.1.1"}),

...
type AccountAIRunHfNousresearchExecuteHermes2ProMistral7bParamsBodyMessages struct {
	...
	Messages param.Field[[]AccountAIRunHfNousresearchExecuteHermes2ProMistral7bParamsBodyMessagesMessage] `json:"messages" api:"required"`
	// Decreases the likelihood of the model repeating the same lines verbatim.
	FrequencyPenalty param.Field[float64]                                                                          `json:"frequency_penalty"`
...
type AccountAIRunHfNousresearchExecuteHermes2ProMistral7bParamsBodyMessagesToolsObject struct {
	...
	Parameters param.Field[AccountAIRunHfNousresearchExecuteHermes2ProMistral7bParamsBodyMessagesToolsObjectParameters] `json:"parameters" api:"required"`
}
...
type AccountAIRunHfNousresearchExecuteHermes2ProMistral7bParamsBodyMessagesToolsObjectParameters struct {
	...
	Properties param.Field[map[string]AccountAIRunHfNousresearchExecuteHermes2ProMistral7bParamsBodyMessagesToolsObjectParametersProperties] `json:"properties" api:"required"`
